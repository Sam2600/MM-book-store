      ...
      <>
         <tr className="hover:bg-gray-50 transition-colors">
            ...
            <td className="px-4 py-4 text-right space-x-3">
               ...
               <button disabled={isAdmin} onClick={() => onDelete(novel.id, 'novel')} className="text-gray-400 hover:text-red-600 transition-colors">
                              ...
                              <li key={idx} className="flex justify-between items-center p-3 hover:bg-blue-50/30 transition-colors">
                                 ...
                                 <div className="flex items-center space-x-4">
                                    ...
                                    <div className="flex space-x-2 border-l pl-4 border-gray-200">
                                       {/* <NavLink to={ROUTES.CHAPTER_BY_ID.replace(":novelId", novel.id).replace(":chapterId", chapter.id)}>
                                 ...
                                 <tbody className="divide-y divide-gray-200">
                                    {usernfoAndBooks?.novel_list?.map((novel) => (
                                       <NovelManagementRow 
                                          ...
                                          isAdmin={usernfoAndBooks?.user_id != 1}
                                       />
                                    ))}
                                 </tbody>
                              </table>
